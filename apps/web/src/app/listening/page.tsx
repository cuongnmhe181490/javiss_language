...
} from "@/lib/content/listening-data";
      ...
      <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <div className="mb-10">
          ...
          <p className="mt-3 max-w-2xl text-base leading-7 text-slate-400">
            Nghe hội thoại trong các tình huống thực tế. Đọc transcript, trả lời
            câu hỏi và cải thiện kỹ năng nghe hiểu.
          </p>
        </div>
        ...
        <div className="rounded-md bg-slate-800/60 p-4">
          ...
          <div className="space-y-1.5">
            {transcript.map((line, i) => {
              ...
              const speaker =
                colonIndex > -1 ? line.slice(0, colonIndex) : null;
              const text =
                colonIndex > -1 ? line.slice(colonIndex + 1).trim() : line;
              return (

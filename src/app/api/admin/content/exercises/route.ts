import { createExerciseSchema } from "@/features/admin/schemas";
import { getSession } from "@/lib/auth/session";
import { AppError, getErrorMessage } from "@/lib/utils/app-error";
import { fail, ok } from "@/lib/utils/response";
import { createExerciseContent } from "@/server/services/content.service";
...
export async function POST(request: Request) {
  try {
    ...
    const result = await createExerciseContent({
